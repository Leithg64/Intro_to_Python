...
nachos = Recipe("Nachos", ["Chips", "Salsa", "Guacamole", "Cheese"], 25)
cake = Recipe("Cake", ["Sugar", "Butter", "Eggs", "Flour", "Baking Powder", "Milk"], 50)
smoothie = Recipe("Pizza", ["Dough", "Sauce", "Pepperoni", "Cheese"], 30)

# Add recipes to a list
recipes_list = [tea, nachos, cake, smoothie]
...
for ingredient in ["Water", "Sugar", "Cheese"]:
